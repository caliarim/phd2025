Advances in Numerical Analysis and Mathematical Modelling:
exponential integrators for systems of Ordinary Differential Equations

Abstract: This advanced course explores the theory, development, and
...
- polynomial or rational numerical techniques for approximating matrix
functions, also in large-scale systems;
- implementation Techniques: Practical considerations for implementing
exponential integrators on modern computer systems;
- applications to Advection-Diffusion-Reaction and Schrödinger equations,
among others.
...
Every Thursday, from January 16 to February 20, from 10:30 to 12:30,
EXCLUDED February 6;
